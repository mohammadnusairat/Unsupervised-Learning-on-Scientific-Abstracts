...
# from wordcloud import WordCloud # Remove the wordcloud import in your code. Autograder doesn’t test the plotting functions.
...
Instructions:
    ...
    hw4.ipynb. Save as `hw4.py`. Submit along with `hw4.ipynb`
    to Gradescope.

    There is only one assignment listing for HW4 on Gradescope titled 'Homework 04'.
    You are to submit both files there. If either file is missing, or is misspelt,
    the autograder will let you know. 

    The autograder that will verify your functions using your submitted
    `hw4.py`. This constitutes 60% of the total grade for HW4. Manual grading
    of the plot generating functions (by manual execution) and written
    questions will constitute the remaining 40%.

    You are not required to submit a PDF version of your notebook for this
    assignment. Which means that we will grade your plots and written 
    answers using your `hw4.ipynb` alone. So make sure your written
    answers and plot generating functions are present in the notebook
